...
module.exports = (bot, bot_call, builder, calling) => {
    ...
    bot_call.dialog('/help', [
        function (session, args) {
            calling.Prompt.value(" Please Let me know ! which department information your want");
        ...
        function (session, results, args) {
            ...
            calling.Prompt.value(" Please Let me know ! what information you need regarding" + session.Details.Department);
        },
        function (session, results, args) {
    ...
    bot_call.dialog('/rebook', [
        function (session) {
            calling.Prompt.value("This is rebook for you");
